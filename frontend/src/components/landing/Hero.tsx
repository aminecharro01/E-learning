    ...
    <section id="home" className="landing-hero scroll-mt-20">
      ...
      <div className="landing-container relative z-[1] grid items-center gap-12 pt-28 pb-20 lg:grid-cols-12 lg:gap-10 lg:pt-36 lg:pb-28">
        <div className="flex flex-col gap-7 lg:col-span-6">
          ...
          <p className="max-w-xl text-lg leading-relaxed landing-text-on-dark-muted">
            {iat.subtitle}
          </p>
          ...
          <div className="landing-hero-photos">
            <div className="landing-hero-photo-main">
              ...
              <div className="landing-hero-photo-caption">
                ...
                <p className="landing-text-on-dark mt-1 text-lg font-semibold">Apprendre en pratiquant</p>
              </div>
            </div>
            <div className="landing-hero-photo-secondary">
              <Image
