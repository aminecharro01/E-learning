...
Le stage s'est déroulé du \DateDebutStage{} au \DateFinStage. Le
...
Ce chapitre a présenté le contexte métier d'\Entreprise, la problématique
...
chapitre~\ref{ch:analyse-besoins} détaille maintenant l'analyse
