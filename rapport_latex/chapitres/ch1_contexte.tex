...
Secteur d'activité & Formation professionnelle --- aviation, accueil, tourisme \\
Filières préparées & Hôtesse de l'air / Steward, Agent d'escale, Accompagnateur touristique, Réception hôtelière \\
Durée du cursus & 2 ans (formation continue, présentiel + stage intégré) \\
...
Directeur pédagogique & Valide manuellement les étapes du cursus qui ne
  ...
  gère les utilisateurs et les campagnes de communication. \\
Formateurs & Conçoivent le contenu de cours et les quiz, corrigent les
  réponses libres, encadrent les cohortes. \\
Apprenants & Suivent leur parcours, passent les évaluations, déposent
  leur dossier de stage, obtiennent leur certificat. \\
...
\begin{table}[H]
  ...
  \begin{tabular}{@{}>{\bfseries}p{4cm}p{2.8cm}p{6.2cm}@{}}
    ...
    Conception & Semaines 2--3 & Modélisation des entités, choix
      d'architecture, définition des mécanismes de sécurité. \\
    Développement & Semaines 3--8 & Implémentation backend et frontend,
      ...
      stage, certification, communication). \\
