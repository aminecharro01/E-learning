...
Le modèle de données regroupe 37 entités JPA. Plutôt qu'un diagramme
unique --- illisible à cette échelle, les relations transversales
produisant un enchevêtrement de lignes ---, il est présenté ici par
domaine fonctionnel : structure pédagogique et groupes
...
\begin{sidewaysfigure}
  \centering
  \includegraphics[width=\textwidth,height=0.9\textwidth,keepaspectratio]{diagramme_architecture.png}
