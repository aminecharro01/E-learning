...
Ce chapitre a présenté l'architecture logicielle et de déploiement, le
modèle de données et la stratégie de sécurité qui structurent
\Entreprise. Le chapitre~\ref{ch:realisation} détaille maintenant comment
ces choix se traduisent dans l'implémentation, en particulier sur les
