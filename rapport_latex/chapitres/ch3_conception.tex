...
\begin{table}[H]
  ...
  \begin{tabular}{@{}p{3.2cm}p{9cm}@{}}
    ...
    Spring Boot 3 / Java 21~\cite{springboot-docs} & Écosystème mature,
      ...
      avec des règles de progression complexes. \\
    ...
    Redis~\cite{redis-docs} & Structures de données en mémoire adaptées
      ...
      PostgreSQL de lectures/écritures fréquentes et volatiles. \\
    ...
    Next.js 15~\cite{nextjs-docs} (frontend) & Rendu serveur pour les
      ...
      vérification de certificat, voir \S\ref{sec:certificat-linkedin}). \\
